...
const excludedCategories = ["food", "ep1", "dinner", "vegetarian-friendly"];
const filteredCategories = post.categories.filter((category) => !excludedCategories.includes(category));
const filteredCategoriesString = filteredCategories.join(", ");
console.log("filteredCategoriesString is: ", filteredCategoriesString);
const categories = document.createElement("div");
categories.classList.add("detail-categories");
categories.textContent = filteredCategoriesString;
detailContainer.appendChild(categories);
