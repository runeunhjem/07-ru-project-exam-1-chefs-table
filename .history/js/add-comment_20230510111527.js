...
fetch("https://your-wordpress-site.com/wp-json/wp/v2/comments", {
  ...
  to application/json and the Authorization header set to a bearer token that grants permission to create new comments. The body of the request contains the comment data, including the post, author_name, author_email, and content parameters.
