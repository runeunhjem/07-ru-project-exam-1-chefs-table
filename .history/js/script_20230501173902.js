...
function updateCarousel() {
  ...
  for (let i = startIndex; i < endIndex; i++) {
    ...
    // append child elements to post container
    carousel.appendChild(postContainer);
  }

  const indicatorDots = indicatorWrapper.querySelectorAll(".carousel-indicator-dot");
  ...
  prevArrow.classList.toggle("disabled", page === 0);
  nextArrow.classList.toggle("disabled", page === totalPages - 1);
}
