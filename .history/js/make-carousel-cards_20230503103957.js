...
function handleInitialViewport() {
  ...
  if (viewportWidth >= breakpoints["(max-width: 576px)"]) {
    handleViewportChange(breakpoints["(max-width: 576px)"]);
  } else if (viewportWidth >= breakpoints["(max-width: 768px)"]) {
    handleViewportChange(breakpoints["(max-width: 768px)"]);
  } else if (viewportWidth >= breakpoints["(max-width: 1150px)"]) {
...
// call handleInitialViewport on page load
