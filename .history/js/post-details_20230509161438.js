...
recipe.textContent = post.recipe;
recipeContainer.appendChild(recipe);
const recipeList = document.createElement("ul");  // Create a new unordered list element
...
recipeContainer.appendChild(recipeList);   // Add the unordered list to the detail container
