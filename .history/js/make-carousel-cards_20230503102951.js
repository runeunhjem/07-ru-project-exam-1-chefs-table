...
function handleViewportChange(breakpoint) {
  ...
  if (breakpoint >= breakpoints["(max-width: 768px)"] && breakpoint < breakpoints["(max-width: 1150px)"]) {
    postsPerSlide = 1;
  } else if (breakpoint >= breakpoints["(max-width: 1150px)"] && breakpoint < breakpoints["(max-width: 1600px)"]) {
    postsPerSlide = 2;
  } else if (breakpoint >= breakpoints["(max-width: 1600px)"] && breakpoint < breakpoints["(max-width: 3200px)"]) {
    postsPerSlide = 3;
  } else {
    postsPerSlide = 4;
  }
