...
(async function () {
  ...
  for (const post of posts) {
    ...
    detailContainer.classList.add("post-image-container");
    postContainer.appendChild(detailContainer);
    ...
    detailContainer.appendChild(tagLine);

    const tags = document.createElement("p");
    tags.classList.add("post-tags");
    tags.textContent = `Tags: ${post.tags.join(", ")}`;
    detailContainer.appendChild(tags);
    ...
    detailContainer.appendChild(added);
