...
function handleInitialViewport() {
  ...
  if (viewportWidth >= breakpoints["(max-width: 576px)"] && breakpoints < breakpoints["(max-width: 768px)"]) {
    handleViewportChange(breakpoints["(max-width: 576px)"]);
  } else if (viewportWidth >= breakpoints["(max-width: 768px)"] && breakpoints < breakpoints["(max-width: 1150px)"]) {
    handleViewportChange(breakpoints["(max-width: 768px)"]);
  } else if (viewportWidth >= breakpoints["(max-width: 1150px)"] && breakpoints < breakpoints["(max-width: 1600px)"]) {
