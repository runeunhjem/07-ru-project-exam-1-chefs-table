...
async function renderPosts() {
  ...
  const latestPostsContainer = document.getElementById("main-latest-posts-container");
  latestPostsContainer.innerHTML = "";

  // Render the updated posts
  const postsToShow = filteredAndSortedPosts.slice(0, numToShow); // Get the remaining posts to show
  ...
  postsToShow.forEach((post) => {
    ...
    published.textContent = `Published: ${dateString}`;
    detailsContainer.appendChild(published);
