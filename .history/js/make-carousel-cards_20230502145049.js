...
(async function () {
  ...
  carousel.addEventListener("touchmove", (event) => {
    if (isSwiping) {
      ...
      carousel.style.transform = `translateX(-${currentPosition * cardWidth * 3 + diffX}px)`; // move carousel
    }
  });
  ...
  carousel.addEventListener("touchend", () => {
    if (isSwiping) {
      ...
      carousel.style.transform = `translateX(-${currentPosition * cardWidth * 3}px)`; // move carousel to final position
