...
function handleInitialViewport() {
  ...
  if (viewportWidth >= breakpoints.small && viewportWidth < breakpoints.medium) {
    handleViewportChange(breakpoints.small);
  } else if (viewportWidth >= breakpoints.medium && viewportWidth < breakpoints.large) {
    handleViewportChange(breakpoints.medium);
  } else if (viewportWidth >= breakpoints.large && viewportWidth < breakpoints.xlarge) {
    handleViewportChange(breakpoints.large);
  } else {
    handleViewportChange(breakpoints.xlarge);
  }
}
...
function handleViewportChange(breakpoint) {
  ...
  if (breakpoint >= breakpoints.small && breakpoint < breakpoints["(max-width: 768px)"]) {
    postsPerSlide = 1;
