...
async function handleSubmit(event) {
  ...
  const your-email = document.getElementById("your-email").value;
  const your-subject = document.getElementById("your-subject").value;
  const your-message = document.getElementById("your-message").value;

  // Construct the payload
  const payload = {
    your-name: name, // Replace with the actual field name in your Contact Form 7 form
    your-email: email,
