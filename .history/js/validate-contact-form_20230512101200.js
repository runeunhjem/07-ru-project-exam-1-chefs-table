function validateContactForm() {
  ...
  function validateForm(event) {
    ...
    if (checkLength(contactName.value, 3)) {
      ...
      contactS.style.backgroundColor = "#8fff98";
      contactName.style.color = "#000000";
    } else {
      contactNameError.style.display = "block";
      contactName.style.backgroundColor = "#fafad2";
  ...
  contactName.addEventListener("input", validateCommentForm);
  contactEmail.addEventListener("input", validateCommentForm);
  contactSubject.addEventListener("input", validateCommentForm);
  contactContent.addEventListener("input", validateCommentForm);
}
