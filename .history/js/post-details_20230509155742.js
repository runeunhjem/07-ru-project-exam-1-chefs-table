...
recipeTitle.classList.add("detail-category-title");
recipeTitle.textContent = "Categories: ";
categoryContainer.appendChild(recipeTitle);

const categories = document.createElement("div");
categories.classList.add("detail-categories");
categories.textContent = post.recipe;
categoryContainer.appendChild(categories);
