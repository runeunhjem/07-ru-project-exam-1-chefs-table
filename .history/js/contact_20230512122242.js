...
const form = document.getElementById('your-form-id'); // Replace with the ID of your form
...
function handleSubmit(event) {
  ...
  const payload = {
    your_name_field_name: name, // Replace with the actual field name in your Contact Form 7 form
    your_email_field_name: email,
    your_message_field_name: message,
  };

  // Send POST request to Contact Form 7 API
  fetch('https://your-wordpress-site/wp-json/contact-form-7/v1/contact-forms/{form-id}/feedback', {
    method: 'POST',
