...
tagsContainer.classList.add("detail-tags-container");
...
const excludedCategories = ["food", "ep1"];
const filteredCategories = post.categories.filter((tags) => !excludedCategories.includes(tags.toLowerCase()));
const filteredCategoriesString = filteredCategories.join(", ");
const categories = document.createElement("div");
categories.classList.add("detail-categories");
categories.textContent = filteredCategoriesString;
tagsContainer.appendChild(categories);
